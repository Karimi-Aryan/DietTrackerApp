...
public class SettingsUpdateUI extends javax.swing.JFrame {
    ...
    private void metricUnitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_metricUnitbtnActionPerformed
        ...
        if (this.user.getUnits().equals("Metric")) {
            ...
            this.user.setWeight(Math.round((this.user.getWeight() * 2.2046) * 100.0) / 100.0);
            this.user.setHeight(Math.round((this.user.getHeight() * 0.3937) * 100.0) / 100.0);
        }
        this.user.setUnits("Metric");
        dispose();
    ...
    private void ImperialBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ImperialBTNActionPerformed
        ...
        if (this.user.getUnits().equals("Imperial")) {
            ...
            this.user.setWeight(Math.round((this.user.getWeight() * 0.4536) * 100.0) / 100.0);
            this.user.setHeight(Math.round((this.user.getHeight() * 2.54) * 100.0) / 100.0);
        }
        dispose();
        AccountHomePageUI home = new AccountHomePageUI(this.user);
        home.HomePageUI(this.user);
